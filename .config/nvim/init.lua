...
-- ============================================================
-- SECTION 9: DATABASE
-- nvim-dbee for browsing SQLite, Postgres, etc.
-- ============================================================
do
  vim.pack.add {
  ...
  require('dbee').setup {
    sources = {
      require('dbee.sources').FileSource:new(dbee_dir .. '/connections.json'),
    },
  }

  vim.keymap.set('n', '<leader>db', function() require('dbee').toggle() end, { desc = '[D]ata[B]ase toggle' })
end
